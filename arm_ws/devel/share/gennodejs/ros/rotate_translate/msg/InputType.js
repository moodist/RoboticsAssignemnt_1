...
// (in-package rotate_translate.msg)
...
class InputType {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type InputType
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type InputType
    let len;
    let data = new InputType(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new InputType(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
